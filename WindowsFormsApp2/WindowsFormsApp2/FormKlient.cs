...
namespace WindowsFormsApp2
{
    public partial class FormKlient : Form
    {
        ...
        private void FormKlient_Load(object sender, EventArgs e)
        {
            ...
            MySqlConnection conn = new MySqlConnection(connStr);
            sql = "SELECT ID_Klienta, FIO, Nazvanie_Kompanii, Adres, Telefon FROM Klient ";
            conn.Open();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            MySqlConnection conn = new MySqlConnection(connStr);
            conn.Open();
            string sql = "UPDATE Klient SET FIO= '" + textBox1.Text + "', Nazvanie_Kompanii= '" + textBox2.Text + "', Adres= '" + textBox3.Text + "', Telefon= '" + textBox4.Text + "' WHERE ID_Klienta= " + edit_test.test_id;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            string connStr = "server = chuc.caseum.ru; user = st_2_18_2; database = is_2_18_st2_VKR; password = 58791144 ; port = 33333";
            MySqlConnection conn = new MySqlConnection(connStr);
            string sql = "DELETE FROM Klient WHERE ID_Klienta = " + edit_test.test_id;
            MySqlCommand comm = new MySqlCommand(sql, conn);
            try
            {
                conn.Open();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MySqlConnection conn = new MySqlConnection(connStr);
                conn.Open();
                string sql = "INSERT INTO Klient (FIO, Nazvanie_Kompanii, Adres, Telefon) VALUE ('" + textBox6.Text + "','" + textBox5.Text + "','" + textBox8.Text + "'," + textBox7.Text + ")";
            ...
            catch
            {
                ...
                {
                    MessageBox.Show("Заполните поля ФИО и Телефон");
                }
        ...
        private void dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            sql = "SELECT FIO, Nazvanie_Kompanii, Adres, Telefon  FROM Klient WHERE ID_Klienta = " + edit_test.test_id;
