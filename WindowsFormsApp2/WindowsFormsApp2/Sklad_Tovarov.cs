...
{
    public partial class Sklad_Tovarov : Form
    {
        interface Programm
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MySqlConnection conn = new MySqlConnection(connStr);
                conn.Open();
                string sql = "INSERT INTO Sklad_Tovarov (Naimenovanie_Tovara, Kolichestvo_Tovara, FIO_Sotrudnika) VALUE ('" + comboBox2.Text + "'," + textBox5.Text + ",'" + textBox1.Text + "')";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string connStr = "server = chuc.caseum.ru; user = st_2_18_2; database = is_2_18_st2_VKR; password = 58791144 ; port = 33333";
            MySqlConnection conn = new MySqlConnection(connStr);
            string sql = "DELETE FROM Sklad_Tovarov WHERE ID_Tovara = " + edit_test.test_id;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            MySqlConnection conn = new MySqlConnection(connStr);
            conn.Open();
            string sql = "UPDATE Sklad_Tovarov SET  Naimenovanie_Tovara= '" + comboBox1.Text + "', Kolichestvo_Tovara= '" + textBox4.Text + "', FIO_Sotrudnika= '" + textBox7.Text + "' WHERE ID_Tovara= " + edit_test.test_id;
            MySqlCommand comm = new MySqlCommand(sql, conn);
            comm.ExecuteNonQuery();
            conn.Close();
            sk.delegatt(dataGridView1);
        ...
        private void dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            sql = "SELECT Naimenovanie_Tovara, Kolichestvo_Tovara, FIO_Sotrudnika FROM Sklad_Tovarov WHERE ID_Tovara = " + edit_test.test_id;
            ...
            comboBox1.ValueMember = "ID_Tovara";
            //Формируем строку запроса на отображение списка статусов прав пользователя
            string sql_list_users = "SELECT ID_Tovara, Naimenovanie FROM Tovar";
            list_stud_command.CommandText = sql_list_users;
            list_stud_command.Connection = conn_db;
